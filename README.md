...
# 安装Python依赖
pip install -r skills/img-hamming-skill/requirements.txt
...
```bash
# 处理图片目录
python skills/img-hamming-skill/main.py -d /path/to/images

# 保留拼图文件
python skills/img-hamming-skill/main.py -d /path/to/images --keep-collages

# 自定义描述提示
python skills/img-hamming-skill/main.py -d /path/to/images -p "分析这些图片的商业价值"
```
